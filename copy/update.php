...
$gradesDatabase = new PDO('mysql:dbname=members;host=localhost', 'root', 'fat cat');
$changeSTH = $gradesDatabase->prepare("UPDATE student_graderz SET `$key` = :value WHERE `name` = :unique;");
